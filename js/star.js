class Star {
    ...
    starDisappearAnimation() {
        ...
        this.starAnimationSingleSpriteHeight =
    ...
    drawDisappearStar() {
        if (!this.hasAnimated) {
            ctx.beginPath();
            ctx.drawImage(
                this.starDisappearImage,
                0,
                this.starAnimationIndex * this.starAnimationSingleSpriteHeight,
                this.starAnimationSpriteWidth,
                this.starAnimationSingleSpriteHeight,
                this.position.x - this.starAnimationSpriteWidth / 2,
                this.position.y -
                    this.starAnimationSingleSpriteHeight / 2 -
                    this.dy,
                this.starAnimationSpriteWidth,
                this.starAnimationSingleSpriteHeight
            );
